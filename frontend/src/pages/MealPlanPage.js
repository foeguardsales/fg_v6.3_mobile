...
export const MealPlanPage = () => {
  ...
  const renderStepContent = () => {
    ...
    if (step === 1) {
      return (
        <div>
          <h1 style={{ fontSize: '32px', fontWeight: '600', marginBottom: '12px', textAlign: 'center', fontFamily: "'Lora', serif", textTransform: 'none' }}>
        ...
        return (
          <div>
            <div style={{ textAlign: 'center', marginBottom: '40px' }}>
              ...
              <h1 style={{ fontSize: '32px', fontWeight: '600', marginBottom: '12px', fontFamily: "'Lora', serif", textTransform: 'none' }}>
                Profile Saved!
              </h1>
