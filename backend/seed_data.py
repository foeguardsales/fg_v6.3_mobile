...
COMFORT_DINNER_PRODUCTS = [
    {
        ...
        "mini_description": "Farm-fresh chicken, perfect for sensitive stomachs. Gently prepared to support digestive health. Ideal for dogs transitioning to raw or those with food sensitivities.",
    ...
    },
    {
        ...
        "protein_type": "beef",
        "name": "Comfort Beef",
        "mini_description": "Grass-fed Ontario beef, rich in nutrients. Packed with iron and B vitamins to support muscle development and energy. Sourced from local farms committed to sustainable practices.",
    ...
    },
    {
        ...
        "protein_type": "fish",
        "name": "Comfort Fish",
        "mini_description": "Wild-caught fish, omega-3 rich. Supports healthy skin, coat, and cognitive function. Sustainably sourced from cold Canadian waters for maximum freshness.",
...
PRIMAL_FEAST_PRODUCTS = [
    ...
    },
    {
        ...
        "protein_type": "duck",
        "name": "Primal Duck",
        "mini_description": "Raw duck, rich flavor. Naturally fatty acids support skin and coat health. Wild game nutrition for the domestic dog.",
