...
COMFORT_DINNER_PRODUCTS = [
    {
        ...
        "mini_description": "Farm-fresh chicken, perfect for sensitive stomachs. Gently prepared to support digestive health while providing nutrition. Ideal for dogs transitioning to raw or those with food sensitivities.",
    ...
    },
    {
        ...
        "protein_type": "beef",
        "name": "Comfort Beef",
        "mini_description": "Grass-fed Ontario beef, rich in nutrients. Packed with iron and B vitamins, this formula supports muscle development and energy. Sourced from local farms committed to sustainable practices.",
    ...
    },
    {
        ...
        "protein_type": "duck",
        "name": "Comfort Duck",
        "mini_description": "Premium duck, great for food sensitivities. Naturally rich in iron and selenium, supporting immune health. A novel protein option for dogs with common protein allergies.",
    ...
    },
    {
        ...
        "protein_type": "fish",
        "name": "Comfort Fish",
        "mini_description": "Wild-caught fish, omega-3 rich. Supports healthy skin, coat, and cognitive function. Sustainably sourced from cold Canadian waters for maximum freshness and nutritional value.",
    ...
    },
    {
        ...
        "protein_type": "goat",
        "name": "Comfort Goat",
        "mini_description": "Lean goat protein, novel protein option. Highly digestible and lower in fat than traditional proteins. Excellent for dogs with allergies or weight management needs.",
    ...
    },
    {
        ...
        "protein_type": "lamb",
        "name": "Comfort Lamb",
        "mini_description": "Premium lamb, highly digestible. Rich in zinc and B vitamins, supporting immune function and metabolism. Grass-fed for superior flavor and nutrition.",
    ...
    },
    {
        ...
        "protein_type": "rabbit",
        "name": "Comfort Rabbit",
        "mini_description": "Exotic rabbit protein, hypoallergenic. One of the leanest proteins available, perfect for elimination diets. High in B12 and selenium for optimal health.",
    ...
    },
    {
        ...
        "protein_type": "turkey",
        "name": "Comfort Turkey",
        "mini_description": "Lean turkey, low-fat option. High in protein and low in fat, ideal for maintaining healthy weight. Rich in tryptophan for calm, balanced energy.",
...
PRIMAL_FEAST_PRODUCTS = [
    {
        ...
        "protein_type": "chicken",
        "name": "Primal Chicken",
        "mini_description": "Raw chicken, species-appropriate nutrition. Delivers biologically appropriate meals that mirror what carnivores eat in nature. Maximum nutrient retention through minimal processing.",
    ...
    },
    {
        ...
        "protein_type": "beef",
        "name": "Primal Beef",
        "mini_description": "Raw beef, protein-packed. Muscle meat, organ meats, and ground bone provide nutrition. Rich, satisfying flavor dogs instinctively crave.",
    ...
    },
    {
        ...
        "protein_type": "duck",
        "name": "Primal Duck",
        "mini_description": "Raw duck, rich flavor. Natural fatty acids support skin and coat health. Wild game nutrition for the domestic dog.",
    ...
    },
    {
        ...
        "protein_type": "fish",
        "name": "Primal Fish",
        "mini_description": "Raw fish, omega-rich. Cold-water fish provide EPA and DHA for brain and heart health. Clean, sustainable protein source.",
    ...
    },
    {
        ...
        "protein_type": "goat",
        "name": "Primal Goat",
        "mini_description": "Raw goat, novel protein. Lean and easily digestible, perfect for sensitive systems. Unique flavor profile for variety.",
    ...
    },
    {
        ...
        "protein_type": "lamb",
        "name": "Primal Lamb",
        "mini_description": "Raw lamb, premium quality. Grass-fed lamb delivers CLA and omega-3s. Rich taste and amino acid profile.",
    ...
    },
    {
        ...
        "protein_type": "rabbit",
        "name": "Primal Rabbit",
        "mini_description": "Raw rabbit, exotic choice. Ultra-lean protein for weight management. Naturally hypoallergenic and highly digestible.",
    ...
    },
    {
        ...
        "protein_type": "turkey",
        "name": "Primal Turkey",
        "mini_description": "Raw turkey, lean protein. Low-fat, high-protein option for active dogs. Organ meats and bone for nutrition.",
