...
COMFORT_DINNER_PRODUCTS = [
    {
        ...
        "mini_description": "A light meal that supports digestion and everyday vitality for dogs of all life stages.",
...
PRIMAL_FEAST_PRODUCTS = [
    ...
    },
    {
        ...
        "mini_description": "Cold-water fish providing EPA and DHA for brain and heart health from a clean, sustainable source.",
    ...
    },
    {
        ...
        "mini_description": "Grass-fed lamb delivering CLA and omega-3s with a rich taste and amino acid profile.",
    ...
    },
    {
        ...
        "mini_description": "Low-fat, high-protein option for active dogs with organ meats and bone for natural nutrition.",
